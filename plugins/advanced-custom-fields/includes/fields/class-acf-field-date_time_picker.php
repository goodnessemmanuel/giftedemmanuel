...
class acf_field_date_and_time_picker extends acf_field {
	...
	*/
	...
	function input_admin_enqueue_scripts() {
		...
		// script
		wp_enqueue_script('acf-timepicker', acf_get_url('assets/blocks/timepicker/jquery-ui-timepicker-addon.min.js'), array('jquery-ui-datepicker'), $version);
		
		
		// style
		wp_enqueue_style('acf-timepicker', acf_get_url('assets/blocks/timepicker/jquery-ui-timepicker-addon.min.css'), '', $version);
