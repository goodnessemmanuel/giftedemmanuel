	...
	*/
	...
	function input_admin_enqueue_scripts() {
		...
		if( $major == 4 ) {
			...
			$version = '4.0';
			$script = acf_get_url("assets/blocks/select2/4/select2.full{$min}.js");
			$style = acf_get_url("assets/blocks/select2/4/select2{$min}.css");
		
		// v3
		} else {
			
			$version = '3.5.2';
			$script = acf_get_url("assets/blocks/select2/3/select2{$min}.js");
			$style = acf_get_url("assets/blocks/select2/3/select2.css");
